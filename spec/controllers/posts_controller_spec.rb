...
RSpec.describe PostsController, type: :controller do
  ...
  let(:valid_attributes) { { title: 'Test Title', body: 'Test Body', category: 'Cultura', user_id: user.id } }
...
describe 'DELETE #destroy' do 
    it 'destroys the requested post' do 
        post = Post.create! valid_attributes expect { delete :destroy, params: { id: post.to_param } }.to change(Post, :count).by(-1) 
    end
